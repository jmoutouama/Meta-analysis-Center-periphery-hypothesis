...
```{r}
dir.create('/Users/jm200/Library/CloudStorage/Dropbox/Manuscript/Figures',showWarnings = F)
dir.create('/Users/jm200/Library/CloudStorage/Dropbox/Manuscript/Tables',showWarnings = F)
```
...
```{r}
Lambdacp <- read.csv("C:/Users/jm200/Documents/Data/Lambda.csv", header = T)
```
...
Lambdar <- read.csv("C:/Users/jm200/Documents/Data/Lambdar.csv", header = T)
...
```{r}
gencp <- read.csv("C:/Users/jm200/Documents/Data/genetic.csv", header = T)
genr <- read.csv("C:/Users/jm200/Documents/Data/geneticr.csv", header = T)
